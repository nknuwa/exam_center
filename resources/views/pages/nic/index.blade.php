            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div>
                        ...
                        <small class="text-muted">
                            Candidate NIC Correction Management
                        </small>
                    </div>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <form action="{{ route('nic.store') }}" method="POST" id="nicForm">
                            @csrf
                            @php
                            ...
                            <div class="row g-3 mt-1">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="old_nic"
                                        id="old_nic">
                                    @error('old_nic')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="new_nic"
                                        id="new_nic">
                                    @error('new_nic')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control form-control-sm" rows="3" name="reason"></textarea>
                                </div>
